...
export class RoomService {
  ...
  public createRoomInBuilding(building_id, room_name, room_type, capacity) {
    return this.http.post(`${AppConfig.environment}/buildings/${building_id}/rooms`, {room_name, room_type, capacity});
  }

  public updateRoom(id: string, room: Room) {
    return this.http.put(`${AppConfig.environment}/rooms/${id}`, { room_name: room.room_name, room_type: room.room_type, capacity: room.capacity });
  }
