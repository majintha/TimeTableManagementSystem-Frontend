...
import { SessionsMComponent } from './components/dashboard/sessionsM/sessionsM.component';
import { AddSessionComponent } from './components/dashboard/sessions/add-session/add-session.component';
import { AddSessionMComponent } from './components/dashboard/sessionsM/add-sessionM/add-sessionM.component';
import { ManageSessionsComponent } from './components/dashboard/sessions/manage-sessions/manage-sessions.component';
import { ManageSessionsMComponent } from './components/dashboard/sessionsM/manage-sessionsM/manage-sessionsM.component';
    ...
    children: [
      ...
      //set path here
      {
        ...
        children: [
          ...
          { path: "unava/:id", component: ViewUnavComponent },
          { path : 'add', component : AddSessionMComponent },
          { path : 'manage', component : ManageSessionsMComponent }
        ],
      },
      {
        path: "subjects",
